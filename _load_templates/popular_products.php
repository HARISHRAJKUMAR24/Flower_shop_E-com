            ...
            <div class="container">
                <div class="flex flex-wrap">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <button class="category-btn" data-category="seed">Seeds</button>
                        <button class="category-btn" data-category="medicinal">Medicinal</button>
                        <button class="category-btn" data-category="flower shop">Flower Shop</button>
                        <button class="category-btn" data-category="kodi">Kodi Plant</button>
                    </div>
                </div>
            </div>

            <div class="grid gap-4 grid-cols-1 md:grid-cols-2 lg:gap-4 xl:grid-cols-5 mt-4 product-grid">
                <div class="relative rounded-lg border bg-white border-gray-300 card-product" data-category="seed">
                    <div class="flex-auto p-4">
                        <div class="text-center relative flex justify-center">
                            ...
                            <div class="absolute w-full bottom-[15%] opacity-0 invisible card-product-action">
                                ...
                                <a href="#!" class="h-[34px] w-[34px] leading-[34px] bg-white shadow inline-flex items-center justify-center rounded-lg hover:bg-green-600 hover:text-white" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <a href="#!" class="h-[34px] w-[34px] leading-[34px] bg-white shadow inline-flex items-center justify-center rounded-lg hover:bg-green-600 hover:text-white" data-bs-toggle="tooltip" data-bs-html="true" title="Compare">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Seed</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Mirabilis Jalapa </a></h3>
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="seed">
                    <div class="flex-auto p-4">
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Seed</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">December Flower</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="seed">
                    <div class="flex-auto p-4">
                        <div class="text-center relative flex justify-center">
                            <div class="badge-stack">
                                <span class="badge-glass badge-amber">
                                    <span class="dot-glow"></span>
                                    Best Selling
                                </span>
                            </div>
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Seed</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Mari Gold Flower</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="seed">
                    <div class="flex-auto p-4">
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Seed</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Lotus</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="seed">
                    <div class="flex-auto p-4">
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Seed</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Fire Cracker Flower</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="flower shop">
                    <div class="flex-auto p-4">
                        <div class="text-center relative flex justify-center">
                            <a href="#!"><img src="../assets/images/products/jasmine.jpg"
                                    alt="Grocery Ecommerce Template" class="w-full h-auto product-img" /></a>
                            <div class="absolute w-full bottom-[15%] opacity-0 invisible card-product-action">
                                <a href="#!" class="h-[34px] w-[34px] leading-[34px] bg-white shadow inline-flex items-center justify-center rounded-lg hover:bg-green-600 hover:text-white" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View">
                                    <span data-bs-toggle="modal" data-bs-target="#quickViewModal">
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Flower Shop</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Jasmine</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="kodi">
                    <div class="flex-auto p-4">
                        <div class="text-center relative flex justify-center">
                            <a href="#!"><img src="../assets/images/products/moneyplant.jpg"
                                    alt="Grocery Ecommerce Template" class="w-full h-auto product-img" /></a>
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Kodi Plant</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Money Plant</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="flower shop">
                    <div class="flex-auto p-4">
                        <div class="text-center relative flex justify-center">
                            <a href="#!"><img src="../assets/images/products/rose plant.jpg"
                                    alt="Grocery Ecommerce Template" class="w-full h-auto product-img" /></a>
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Flower Shop</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Rose Plant</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="medicinal">
                    <div class="flex-auto p-4">
                        <div class="text-center relative flex justify-center">
                            <a href="#!"><img src="../assets/images/products/aleovera.jpg"
                                    alt="Grocery Ecommerce Template" class="w-full h-auto product-img" /></a>
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Medicinal Plant</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Aloe Vera</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="relative rounded-lg break-words border bg-white border-gray-300 card-product" data-category="medicinal">
                    <div class="flex-auto p-4">
                        <div class="text-center relative flex justify-center">
                            <a href="#!"><img src="../assets/images/products/tulasi.jpg"
                                    alt="Grocery Ecommerce Template" class="w-full h-auto product-img" /></a>
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!" class="text-decoration-none text-gray-500"><small>Medicinal Plant</small></a>
                            <div class="flex flex-col gap-2">
                                <h3 class="text-base truncate"><a href="#!">Tulasi</a></h3>
                                <div class="flex items-center">
                                    <div class="flex flex-row gap-3">
                                        <small class="text-yellow-500 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
