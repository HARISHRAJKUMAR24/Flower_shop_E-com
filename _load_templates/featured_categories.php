<section class="mt-8">
    <div class="container mx-auto relative">
        ...
        <div class="swiper-container swiper" id="swiper-1" data-pagination-type="" data-speed="400"
            data-space-between="20" data-pagination="true" data-navigation="true" data-autoplay="true"
            ...
            <!-- Navigation buttons -->
            <div class="swiper-button-prev text-white bg-black/40 hover:bg-green-600 p-2 rounded-full absolute top-1/2 -left-5 transform -translate-y-1/2"></div>
            <div class="swiper-button-next text-white bg-black/40 hover:bg-green-600 p-2 rounded-full absolute top-1/2 -right-5 transform -translate-y-1/2"></div>
