                ...
                <div class="flex flex-col md:flex-row items-center gap-3">
                    <div class="w-full">
                        <span class="text-sm text-gray-500">
                            ...
                            </span> FreshCart TailwindCSS eCommerce HTML Template. Powered by
                    ...
                    <div class="md:w-1/2 flex md:justify-end items-center">
                        <div class="flex flex-row gap-5 items-center">
                            ...
                            <ul class="flex items-center justify-end text-sm gap-1">
                                <li>
                                    <a href="#!" class="inline-flex justify-center items-center align-middle text-center select-none border font-normal whitespace-no-wrap rounded leading-normal no-underline h-8 w-8 border-gray-300 hover:border-green-600 hover:text-green-600 transition ease-in-out">
