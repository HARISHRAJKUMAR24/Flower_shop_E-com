                    ...
                    <div class="md:w-1/2 lg:w-1/4 px-3">
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <p>Cheaper prices than your local supermarket, great cashback offers to top it off. Get best pricess & offers.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="md:w-1/2 lg:w-1/4 px-3">
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <p>Choose from 5000+ products across food, personal care, household, bakery, veg and non-veg & other categories.
                                </p>
                            </div>
                        </div>
                    </div>
