function initializeSwiperCarousels() {
    document.querySelectorAll(".swiper-container").forEach(t => {
        ...
        "fade" === o && (u.fadeEffect = {
            crossFade: !0
        }), i && (e = t.querySelector(".swiper-pagination")) && (u.pagination = {
            el: e,
            type: p,
            dynamicBullets: !0,
            clickable: !0
        }, "custom" === p) && (u.pagination.renderCustom = function(t, e, a) {
            var i = "";
            for (let t = 1; t <= a; t++) e == t ? i += `<span class="swiper-pagination-numbers swiper-pagination-numbers-active">${t}</span>` : i += `<span class="swiper-pagination-numbers">${t}</span>`;
            return i
        }), r ? u.navigation = {
            nextEl: ".swiper-button-next",
            prevEl: ".swiper-button-prev"
        } : (a = t.querySelector(".swiper-navigation")) && a.classList.add("swiper-navigation-hidden"), n && (u.autoplay = {
            delay: parseInt(s)
        }), new Swiper(t, u)
    })
}
